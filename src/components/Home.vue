<template>
  ...
  <section id="subsidiaries" class="py-28 bg-gray-100 text-center">
    ...
    >
      ...
      <div class="bg-blue-100 shadow-md rounded-2xl p-6 hover:shadow-xl transition flex flex-col justify-between h-full">
    ...
    <div class="grid md:grid-cols-3 gap-6">
      <div
        class="bg-gradient-to-b from-blue-200 to-white shadow-md rounded-2xl p-6"
      >
